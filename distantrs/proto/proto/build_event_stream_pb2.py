...
_TARGETCOMPLETE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='test_timeout_seconds', full_name='build_event_stream.TargetComplete.test_timeout_seconds', index=6,
...
_TESTSUMMARY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='first_start_time_millis', full_name='build_event_stream.TestSummary.first_start_time_millis', index=5,
      number=7, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='last_stop_time_millis', full_name='build_event_stream.TestSummary.last_stop_time_millis', index=6,
      number=8, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='total_run_duration_millis', full_name='build_event_stream.TestSummary.total_run_duration_millis', index=7,
...
_OPTIONSPARSED.fields_by_name['invocation_policy'].message_type = proto_dot_invocation__policy__pb2._INVOCATIONPOLICY
...
_BUILDEVENT.fields_by_name['structured_command_line'].message_type = proto_dot_command__line__pb2._COMMANDLINE
...
BuildEventId = _reflection.GeneratedProtocolMessageType('BuildEventId', (_message.Message,), {
  ...
  'UnknownBuildEventId' : _reflection.GeneratedProtocolMessageType('UnknownBuildEventId', (_message.Message,), {
    ...
    '__module__' : 'proto.build_event_stream_pb2'
